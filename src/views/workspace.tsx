...
function WorkspaceInspectorContext(props: {
  ...
  return (
    <button
      type="button"
      class="workspace-inspector-context workspace-inspector-collapse"
    ...
    >
      ...
      <svg
        class="workspace-inspector-chevron"
        width="14"
        height="14"
        viewBox="0 0 24 24"
        fill="none"
      ...
      <span class="workspace-inspector-close-hint" aria-hidden="true">
        <span>Close</span>
        <kbd>Esc</kbd>
      </span>
    </button>
